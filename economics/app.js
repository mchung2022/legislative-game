...
const QUIZ_QUESTIONS = [
  {
    question: "【需求法則】在其他條件不變下，當商品的價格越高，消費者的需求量就會越低；價格越低，需求量就越高。這種價格與需求量呈反向變動的關係，在經濟學上稱之為【＿＿＿＿】。",
    answers: ["需求法則", "需求定律"],
    explanation: "需求法則指出商品價格與需求量呈反向變動（價格上漲，需求量減少；價格下跌，需求量增加）。"
  },
  {
    question: "【市場均衡】在自由市場中，當買方的「需求量」剛好等於賣方的「供給量」時，價格將達到不再變動的穩定狀態。此時的價格在經濟學上稱之為【＿＿＿＿】。",
    answers: ["均衡價格", "市場均衡價格"],
    explanation: "當供給量與需求量相等時，市場達到均衡，這時的市場價格即為「均衡價格」。"
  },
  {
    question: "【供過於求】某年高麗菜大豐收，農民運送大量蔬菜到市場，但消費者每天的胃口有限，導致菜攤上堆滿高麗菜賣不出去。這種供給量大於需求量的現象，在經濟學上稱之為【＿＿＿＿】（或過剩）。",
    answers: ["供過於求", "超額供給"],
    explanation: "當供給量大於需求量時，市場出現「供過於求」或過剩，會推動市場價格下跌。"
  },
  {
    question: "【替代品】當鮮奶價格大幅上漲時，消費者會改買燕麥奶來泡咖啡，這使得燕麥奶的需求增加。在經濟學上，「燕麥奶」相對於「鮮奶」的角色，稱之為【＿＿＿】。",
    answers: ["替代品"],
    explanation: "當兩種商品能滿足相似需求，且其中一種價格上漲會導致另一種需求增加，這兩種商品互為「替代品」。"
  },
  {
    question: "【政府干預】颱風過後青菜暴漲，政府規定蔬菜每把售價上限（低於均衡價格），旨在保障消費者利益。這種價格上限政策在經濟學上又稱為【＿＿＿＿】。",
